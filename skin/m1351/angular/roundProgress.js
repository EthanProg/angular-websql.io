...
angular.module('angular-svg-round-progress', [])
    .directive('roundProgress', ['$timeout', function($timeout){
            ...
            return {
                ...
                replace:true,
                template:'\
                <svg class="round-progress" >\
                    <circle  fill="none" cx="{{radius}}" cy="{{radius}}" transform="translate({{stroke}}, {{stroke}})" r="{{radius}}" stroke="{{bgcolor}}" stroke-width="{{stroke}}"/>\
                    <circle  fill="{{bgcolor}}" cx="{{radius}}" cy="{{radius}}" transform="translate({{stroke}}, {{stroke}})" r="{{radius-stroke-3}}" stroke="none" stroke-width="{{0}}"/>\
                    <path fill="none" />\
                </svg>'
            };
        }]);
